...
var args26495 = [];
var len__7848__auto___26499 = arguments.length;
var i__7849__auto___26500 = (0);
while(true){
if((i__7849__auto___26500 < len__7848__auto___26499)){
args26495.push((arguments[i__7849__auto___26500]));

var G__26501 = (i__7849__auto___26500 + (1));
i__7849__auto___26500 = G__26501;
continue;
} else {
}
break;
...
var G__26498 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26498,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26498;
}
});
...
var or__6773__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__7848__auto___26506 = arguments.length;
var i__7849__auto___26507 = (0);
while(true){
if((i__7849__auto___26507 < len__7848__auto___26506)){
args__7855__auto__.push((arguments[i__7849__auto___26507]));

var G__26508 = (i__7849__auto___26507 + (1));
i__7849__auto___26507 = G__26508;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7856__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26503){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26504,G__26505,seq26503__$2);
});
...
var line = cljs.core.get.call(null,map__26512__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26512__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26512,map__26512__$1,file,line,column){
return (function (p1__26509_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26509_SHARP_));
});})(map__26512,map__26512__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__7698__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__7698__auto__,prefer_table__7699__auto__,method_cache__7700__auto__,cached_hierarchy__7701__auto__,hierarchy__7702__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6773__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6773__auto__)){
return or__6773__auto__;
} else {
...
var temp__4657__auto___26514 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26514)){
var message_26515 = temp__4657__auto___26514;
cljs.core.println.call(null,message_26515);
} else {
}
...
var temp__4657__auto___26516 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26516)){
var message_26517 = temp__4657__auto___26516;
cljs.core.println.call(null,message_26517);
} else {
}
...
var temp__4655__auto__ = (function (){var and__6761__auto__ = typeof exception.stack === 'string';
if(and__6761__auto__){
var G__26527 = exception.stack;
var G__26527__$1 = (((G__26527 == null))?null:clojure.string.split_lines.call(null,G__26527));
var G__26527__$2 = (((G__26527__$1 == null))?null:cljs.core.get.call(null,G__26527__$1,depth));
if((G__26527__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26527__$2);
}
} else {
...
var vec__26528 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26528,(0),null);
var column = cljs.core.nth.call(null,vec__26528,(1),null);
var vec__26531 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26531,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26531,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26531,(2),null);
...
var m__$1 = (function (){var G__26535 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26535) {
case "fail":
...
var G__26541 = (function (){var G__26540 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26540);
} else {
return G__26540;
}
})();
...
return cljs.core.vary_meta.call(null,G__26543,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__26547 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26547) {
...
var vec__26552 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26552,(0),null);
var types = vec__26552;
...
return cljs.core.map.call(null,(function (p__26564){
var vec__26565 = p__26564;
var ns = cljs.core.nth.call(null,vec__26565,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26565,(1),null);
return ((function (vec__26565,ns,vars__$1){
return (function (){
...
var G__26568 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26568) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1){
return (function (){
var seq__26569 = cljs.core.seq.call(null,vars__$1);
var chunk__26570 = null;
var count__26571 = (0);
var i__26572 = (0);
while(true){
if((i__26572 < count__26571)){
var v = cljs.core._nth.call(null,chunk__26570,i__26572);
var temp__4657__auto___26574 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26574)){
var t_26575 = temp__4657__auto___26574;
each_fixture_fn.call(null,((function (seq__26569,chunk__26570,count__26571,i__26572,t_26575,temp__4657__auto___26574,v,each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26575)));
});})(seq__26569,chunk__26570,count__26571,i__26572,t_26575,temp__4657__auto___26574,v,each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1))
);
} else {
}

var G__26576 = seq__26569;
var G__26577 = chunk__26570;
var G__26578 = count__26571;
var G__26579 = (i__26572 + (1));
seq__26569 = G__26576;
chunk__26570 = G__26577;
count__26571 = G__26578;
i__26572 = G__26579;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__26569);
if(temp__4657__auto__){
var seq__26569__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26569__$1)){
var c__7584__auto__ = cljs.core.chunk_first.call(null,seq__26569__$1);
var G__26580 = cljs.core.chunk_rest.call(null,seq__26569__$1);
var G__26581 = c__7584__auto__;
var G__26582 = cljs.core.count.call(null,c__7584__auto__);
var G__26583 = (0);
seq__26569 = G__26580;
chunk__26570 = G__26581;
count__26571 = G__26582;
i__26572 = G__26583;
continue;
} else {
var v = cljs.core.first.call(null,seq__26569__$1);
var temp__4657__auto___26584__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26584__$1)){
var t_26585 = temp__4657__auto___26584__$1;
each_fixture_fn.call(null,((function (seq__26569,chunk__26570,count__26571,i__26572,t_26585,temp__4657__auto___26584__$1,v,seq__26569__$1,temp__4657__auto__,each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26585)));
});})(seq__26569,chunk__26570,count__26571,i__26572,t_26585,temp__4657__auto___26584__$1,v,seq__26569__$1,temp__4657__auto__,each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1))
);
} else {
}

var G__26586 = cljs.core.next.call(null,seq__26569__$1);
var G__26587 = null;
var G__26588 = (0);
var G__26589 = (0);
seq__26569 = G__26586;
chunk__26570 = G__26587;
count__26571 = G__26588;
i__26572 = G__26589;
continue;
}
} else {
...
});})(each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1))
);
});})(each_fixture_fn,G__26568,env,once_fixtures,each_fixtures,vec__26565,ns,vars__$1))
], null);
