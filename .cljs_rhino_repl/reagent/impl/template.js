...
return cljs.core._write.call(null,writer__7380__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13172 = o;
(G__13172[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__13173__delegate = function (args){
...
while (G__13174__i < G__13174__a.length) {G__13174__a[G__13174__i] = arguments[G__13174__i + 0]; ++G__13174__i;}
  args = new cljs.core.IndexedSeq(G__13174__a,0);
} 
...
var args = cljs.core.seq(arglist__13175);
...
if(cljs.core.truth_((function (){var and__6761__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__6761__auto__){
var and__6761__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6761__auto____$1){
var and__6761__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__13180 = jsprops;
(G__13180["defaultValue"] = value);

(G__13180["onChange"] = ((function (G__13180,v,value,on_change){
return (function (p1__13178_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13178_SHARP_);
});})(G__13180,v,value,on_change))
);
...
var vec__13187 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__13187,(0),null);
var id = cljs.core.nth.call(null,vec__13187,(1),null);
var class$ = cljs.core.nth.call(null,vec__13187,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___13192 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___13192 == null)){
} else {
var key_13193 = temp__4661__auto___13192;
(jsprops["key"] = key_13193);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13195 = (new reagent.impl.template.NativeWrapper());
(G__13195["name"] = c);
...
var len__7848__auto___13201 = arguments.length;
var i__7849__auto___13202 = (0);
while(true){
if((i__7849__auto___13202 < len__7848__auto___13201)){
args__7855__auto__.push((arguments[i__7849__auto___13202]));

var G__13203 = (i__7849__auto___13202 + (1));
i__7849__auto___13202 = G__13203;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7856__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13199){
var G__13200 = cljs.core.first.call(null,seq13199);
var seq13199__$1 = cljs.core.next.call(null,seq13199);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13200,seq13199__$1);
});
...
break;
default:
var G__13207 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__13207;
continue;
...
var n__7688__auto___13210 = a.length;
var i_13211 = (0);
while(true){
if((i_13211 < n__7688__auto___13210)){
(a[i_13211] = reagent.impl.template.as_element.call(null,(a[i_13211])));
...
var a = cljs.core.into_array.call(null,s);
var n__7688__auto___13213 = a.length;
var i_13214 = (0);
while(true){
if((i_13214 < n__7688__auto___13213)){
var val_13215 = (a[i_13214]);
if((cljs.core.vector_QMARK_.call(null,val_13215)) && ((reagent.impl.template.key_from_vec.call(null,val_13215) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13214] = reagent.impl.template.as_element.call(null,val_13215));

var G__13216 = (i_13214 + (1));
i_13214 = G__13216;
continue;
} else {
}
...
var ctx = {};
var vec__13220 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__13220,(0),null);
var derefed = cljs.core.nth.call(null,vec__13220,(1),null);
...
var G__13224 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13224) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__13224){
